      ...
      <div className="relative bg-gray-900/80 backdrop-blur-xl shadow-2xl w-full max-w-5xl grid md:grid-cols-2 grid-cols-1 rounded-3xl border border-gray-800 overflow-hidden animate-fadeInScale">
        ...
        <div className="py-12 px-8 md:px-12">
          <div className="text-center mb-8 animate-fadeInUp">
            <h2 className="font-extrabold text-4xl bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Buat Akun Baru</h2>
            <p className="text-gray-400 mt-2">Daftar untuk memulai</p>
          </div>

          <form className="space-y-4" onSubmit={handleRegiter}>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold rounded-xl shadow-lg hover:shadow-purple-500/50 transform hover:scale-[1.02] transition-all duration-200 animate-fadeInUp delay-400"
            >
            ...
            <div className="text-center pt-2 animate-fadeInUp delay-400">
              <p className="text-gray-400">
                Sudah punya akun?{" "}
                <Link to="/login" className="text-purple-400 hover:text-pink-400 font-semibold transition-colors">
                  Login sekarang
                </Link>
              </p>
            </div>
